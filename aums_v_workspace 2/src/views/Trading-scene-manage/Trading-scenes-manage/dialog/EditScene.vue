...
export default {
  ...
  methods: {
    ...
    initTradeInfo(){
      ...
      this.tradeSceneInfo.SCENECODENAME = this.rowData2.SCENECODENAME;
      this.tradeSceneInfo.SCENECODE = this.rowData2.SCENECODE;
    ...
    tradeSceneEdit(){
      ...
      resBody.data.SCENECODE = this.tradeSceneInfo.SCENECODE;
