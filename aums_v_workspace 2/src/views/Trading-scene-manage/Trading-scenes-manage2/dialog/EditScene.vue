      ...
      <el-card style="margin-bottom:10px;">
        <el-form :model="tradeSceneInfo" ref="tradeSceneInfo"   size="mini" label-position="left" label-width="80px" >
          <el-row :gutter="10">
            ...
            <el-col :md="12" :lg="12">
              <el-form-item label="场景名称" prop="paramKey">
    ...
    <div v-if="active===1">
        <el-card style="margin-bottom:10px;">
                 <el-form ref='matlGroupQuery' :model='matlGroupQuery'  size='mini' label-position="top">
                  ...
                  <el-col  :lg="6" :md="8">
                    <el-form-item label='物料组名称'  prop='devNum'>
                      <el-input v-model='matlGroupQuery.MATLGROUPNAME'  maxlength="50"
                        placeholder="请输入物料组名称"  ></el-input>
                    </el-form-item>
                  </el-col>  
                  <el-col  :lg="6" :md="8">
                    <el-form-item label='物料组ID'  prop='devNum'>
                      <el-input v-model='matlGroupQuery.MATLGROUPID'  maxlength="10"
                      placeholder="请输入物料组ID"  ></el-input>
                    </el-form-item>
                  </el-col>  
                  <el-col  :lg="6" :md="8">
                    <el-form-item label='物料ID'  prop='devNum'>
                      <el-input v-model='matlGroupQuery.MATLID'  
                      placeholder="请输入物料ID"  ></el-input>
                    </el-form-item>
                  </el-col>  
                    ...
                    border>
                      <el-table-column width="50">
                        <template slot-scope="scope">
                          ...
                          v-model="tradeSceneInfo.NECYINMATLGROUPID">{{null}}</el-radio>
                        </template>
                      </el-table-column>
                 ...
                 <div slot="footer" class="dialog-footer" style="text-align:center;">
                  ...
                  <el-button type="primary" size="mini" :disabled="nextStep.nextStep1" style="margin-top: 10px;" @click="next(1)">下一步</el-button>
                </div>
              </div>
              <!-- 附加输入 -->
    <div v-if="active===2">
        <el-card style="margin-bottom:10px;">
                    ...
                    border>
                      <el-table-column width="50">
                        <template slot-scope="scope">
                          <el-radio :label="scope.row.MATLGROUPID"
                          @change.native="getParamID(scope.$index, scope.row)"
                          v-model="tradeSceneInfo.INMATLGROUPID">{{null}}</el-radio>
                        </template>
                      </el-table-column>
                      <el-table-column prop="MATLGROUPID" label="物料组ID"></el-table-column>
                      <el-table-column prop="MATLGROUPNAME" label="物料组名称"></el-table-column>
                 ...
                 <div slot="footer" class="dialog-footer" style="text-align:center;">
                  <el-button type="primary" size="mini" style="margin-top: 10px;" @click="back()">上一步</el-button>
                  <el-button type="primary" size="mini" :disabled="nextStep.nextStep2" style="margin-top: 10px;" @click="next(2)">下一步</el-button>
                </div>
              </div>
              <!-- 输出物料组 -->
    <div v-if="active===3">
        <el-card style="margin-bottom:10px;">
                    ...
                    border>
                      <el-table-column width="50">
                        <template slot-scope="scope">
                          <el-radio :label="scope.row.MATLGROUPID"
                          @change.native="getParamID(scope.$index, scope.row)"
                          v-model="tradeSceneInfo.OUTMATLGROUPID">{{null}}</el-radio>
                        </template>
                      </el-table-column>
                      <el-table-column prop="MATLGROUPID" label="物料组ID"></el-table-column>
                      <el-table-column prop="MATLGROUPNAME" label="物料组名称"></el-table-column>
                 ...
                 <div slot="footer" class="dialog-footer" style="text-align:center;">
                  <el-button type="primary" size="mini" style="margin-top: 10px;" @click="back()">上一步</el-button>
                  <el-button type="primary" size="mini" style="margin-top: 10px;" :disabled="nextStep.nextStep3" @click="next(3)">下一步</el-button>
                </div>
              </div>
    <!-- 确认物料组选择情况 -->
    <div v-if="active===4">
      <el-card style="margin-bottom:10px;">
        ...
        <div slot="footer" class="dialog-footer" style="text-align:center;">
          ...
          <el-button type="primary" size="mini" style="margin-top: 10px;"
          @click="tradeSceneEdit()">确 定</el-button>       
        </div>
    </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    initTradeInfo(){
      ...
      // this.tradeSceneInfo = this.rowData;
      for(var key in this.rowData){
        this.tradeSceneInfo[key]=this.rowData[key];
      }
    },
    //确定维护机构和维护用户的值：
    getOrgnoInfo(){
    ...
    tradeSceneEdit(){
      ...
      resBody.data.SCENECODE = this.rowData.SCENECODE;
