          ...
          <el-row :gutter="10">
            <el-col :md="12" :lg="12" >
               <el-form-item label="英文简称" label-width="100px" prop="MATLGROUPENNAME">
                <el-input v-model="MatlGroupsManageInfo.MATLGROUPENNAME" maxlength="50"
    ...
    <div v-if="active===1">
        <el-card style="margin-bottom:10px;">
                 <el-form ref='matlQuery' :model='matlQuery'  size='mini' label-position="top">
                  ...
                  <el-col  :lg="6" :md="6">
                    <el-form-item label='物料名称'  prop='devNum'>
                      ...
                      placeholder="请输入物料名称" maxlength="50" ></el-input>
                    </el-form-item>
                  </el-col> 
                  <el-col  :lg="6" :md="6">
                    <el-form-item label='物料英文简称'  prop='devNum'>
                      <el-input v-model='matlQuery.MATLENNAME'  
                      placeholder="请输入物料英文简称"  maxlength="20"></el-input>
                    </el-form-item>
                  </el-col> 
                  <el-col  :lg="2" :md="3" class="searchBtnMarginTop">
                    <el-button type='primary' size='mini' icon='el-icon-search' @click="clickQueryMatl()">查询</el-button>
                  </el-col>
                  <el-col  :lg="2" :md="3" class="searchBtnMarginTop">
                    ...
                    border>
                      <el-table-column width="50" fixed="left">
                        <template slot-scope="scope" >
                          ...
                          v-model="matlManageInfo.MATLID">{{null}}</el-radio>
                        </template>
                        </el-table-column>
                      ...
                      <el-table-column prop="CCY" :formatter="ccyFormat" label="币种"></el-table-column>
                      <el-table-column prop="VOUTYPE" :formatter="voutypeFormat" label="凭证类型"></el-table-column>
                 ...
                 <div slot="footer" class="dialog-footer" style="text-align:center;">
                  ...
                  <el-button v-else type="primary" size="mini" style="margin-top: 10px;" :disabled="isNexted" @click="nextTip2()">下一步</el-button>
                </div>
              </div>
    <!-- 凭证类型和序号 -->
    <div v-if="active===2">
