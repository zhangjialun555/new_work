        ...
        <el-card>
          ...
          <el-tabs type="border-card">
            <el-tab-pane label="自助V端角色">
              ...
              <el-button type="primary" size="mini"  @click="dialogOptionsAdd.isShow=true;dialogOptionsAdd.active=0;dialogOptionsAdd.aumsSystem='002';" >新建角色</el-button>
              <el-button type="danger"  :disabled="isDisabledDel" size='mini' @click="delRoleClick">删除角色</el-button>
            </el-tab-pane>
            <el-tab-pane label="自助C端管理员">
              ...
              <el-button type="primary" size="mini"  @click="dialogOptionsAdd.isShow=true;dialogOptionsAdd.active=0;dialogOptionsAdd.aumsSystem='001';" >新建角色</el-button>
              <el-button type="danger"  :disabled="isDisabledDel" size='mini' @click="delRoleClick">删除角色</el-button>                    
            </el-tab-pane>
          </el-tabs>
        </el-card>
          ...
          <el-row>
            <el-col :span="10">
              <div class="roleBlock">
                ...
                <el-button style="margin-left:10px" type="primary" size="mini" :disabled="isDisabledDel" @click="dialogOptionsUpdate.isShow=true;">修改角色信息</el-button>
              </div>  
            </el-col>
            <el-col :span="14">
              <div class="roleBlock">
                ...
                <el-button style="margin-left:10px" type="primary" size="mini" :disabled="isDisabledDel" @click="openRoleRelative">修改角色权限</el-button>
              </div> 
            </el-col>
          </el-row>
          <!-- <div class="userBlock">
...
export default {
  ...
  mounted() {},
  created() {
    this.roleStateEnum = getGlobalParams.get("roleState");
    this.queryUser();
  },
