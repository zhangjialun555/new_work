<template>
  <div class="type-info-manage" v-loading="loading"
    ...
    <!-- <el-card style="overflow:visible"> -->
      ...
      style="min-height:564px;" v-model="tabsPage">
      <!-- 输入物料 -->
      <el-tab-pane label="输入物料" type="border-card" name="In" >
        <el-form size='mini' label-position="top">
        <el-row :gutter="10">
          <el-col  :lg="4" :md="6">
            <el-form-item label="物料名称" size='mini' label-position="top" >
              <el-input  size="mini" maxlength="50" placeholder="请输入物料名称" v-model="InmatlInfoQuery.MATLNAME">
              </el-input>
            </el-form-item>
          </el-col>
          <!-- <el-col  :lg="4" :md="6">
            <el-form-item label="物料ID" >
              <el-input  size="mini"  placeholder="请输入物料ID" maxlength="10" v-model="InmatlInfoQuery.MATLID">
              </el-input>
            </el-form-item>
          </el-col> -->
          <el-col  :lg="4" :md="6">
            <el-form-item label="英文简称" size='mini' label-position="top" >
              <el-input  size="mini" maxlength="20"  placeholder="请输入物料英文简称" v-model="InmatlInfoQuery.MATLENNAME">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :lg="4" :md="6">
            <el-form-item label="物料类型" size='mini' label-position="top">
              <el-select v-model="InmatlInfoQuery.MATLTYPE" placeholder="请选择物料类型"  >
                <el-option 
      ...
      <el-table
        ...
        <el-table-column
            prop="MATLENNAME" label="英文简称" >
        </el-table-column>
        <el-table-column
            prop="MATLTYPE" :formatter="matlTypeFormat" label="物料类型" width="200" >
        </el-table-column>
        <el-table-column
    ...
    <!-- //输出物料 -->
    <el-tab-pane label="输出物料" type="border-card" name="Out" >
        <el-form size='mini' label-position="top">
        <el-row :gutter="10">
          <el-col  :lg="4" :md="6">
            <el-form-item label="物料名称" size='mini' label-position="top" >
              <el-input  size="mini" maxlength="50"  placeholder="请输入物料名称" v-model="OutmatlInfoQuery.MATLNAME">
              </el-input>
            </el-form-item>
          </el-col>
          <!-- <el-col  :lg="4" :md="6">
            <el-form-item label="物料ID" >
              <el-input  size="mini" maxlength="10" placeholder="请输入物料ID"  v-model="OutmatlInfoQuery.MATLID">
              </el-input>
            </el-form-item>
          </el-col> -->
          <el-col  :lg="4" :md="6">
            <el-form-item label="英文简称" size='mini' label-position="top" >
              <el-input  size="mini" maxlength="20"  placeholder="请输入物料英文简称" v-model="OutmatlInfoQuery.MATLENNAME">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :lg="4" :md="6">
            <el-form-item label="物料类型" size='mini' label-position="top">
              <el-select v-model="OutmatlInfoQuery.MATLTYPE" placeholder="请选择物料类型"  >
                <el-option 
                  v-for="item in options"
                  :key="item.value"
                  :label="item.label"
          ...
          <el-col  :lg="2" :md="3" class="searchBtnMarginTop">
            <el-button type='primary' size='mini' icon='el-icon-search' @click="clickOutQuery">查询</el-button>
          </el-col>
          <el-col  :lg="2" :md="3" class="searchBtnMarginTop">
            <el-button type='warning' size='mini' icon='el-icon-refresh'
            @click="resetForm">重置</el-button>
      ...
      <el-row :gutter="10">
        ...
        <el-button type="primary" size="mini"
        icon="el-icon-plus"
        @click="handleOurParameter('add')">新增</el-button>
    
        <el-button type="primary" size="mini" :disabled="BtnGroup2.editBtn"
        @click="handleOurParameter('edit')" icon="el-icon-edit" >编辑</el-button>
    
        <el-button type="danger" size="mini" 
        icon="el-icon-delete" :disabled="BtnGroup2.deleteBtn"
        @click="deleteOutMatl">删除</el-button>

        <el-button type="primary" size="mini" :disabled="BtnGroup2.bindBtn" icon="el-icon-edit-outline"
        @click="handleBindingModel1">交付模式维护</el-button>
      ...
      <el-table
        ...
        <el-table-column width="60">
          <template slot-scope="scope">
            <el-radio :label="scope.row.MATLID"
            @change.native="getOutMatlID(scope, scope.row)"
            v-model="matlId">{{null}}</el-radio>
          </template>
        </el-table-column>  
        <el-table-column
        ...
        <el-table-column
            prop="ISCONTROLNO" label="是否控号" :formatter="isControlNoFormat">
        </el-table-column>
        <el-table-column
            prop="CONTROLMODE" label="控号方式" :formatter="controlModeFormat" >
        </el-table-column>
        <el-table-column
            prop="VOUTYPE" label="凭证类型" :formatter="voutypeFormat" >
        </el-table-column>
        ...
        <el-table-column 
       align="center"
        width="120" label="详细信息" fixed="right">
          <template slot-scope="scope">
            <el-button type="text" size="mini"
            @click="handleQueryParameter(scope.$index, scope.row)">查看</el-button>
          </template>
