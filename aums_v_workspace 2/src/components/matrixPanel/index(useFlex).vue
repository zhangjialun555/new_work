  ...
  <div class="matrix">
    ...
    <div class="labelOption">
      <div class="labelOptionItem"  v-for="(item,index) in devStatuData" :key="index">
        <i :style="'background:'+(devRunStatuTrans[item.devRunningStatus]?devRunStatuTrans[item.devRunningStatus].devRunningStatusColor:'')+';'"></i>
        <span>{{(devRunStatuTrans[item.devRunningStatus]?devRunStatuTrans[item.devRunningStatus].devRunningStatusName:"")}} - {{item.deviceCount}}台</span>
